...
const Section = ({ title, data, selectedIds, onToggle, onAdd }) => {
  ...
  export default function ClosetDrawerContent() {
    ...
    const { mutate: createCategoryMutation, isPending: isCategoryPending } =
      useCreateCategory();
    ...
    const categories = data?.map((i) => ({ id: i.id, name: i.name })) || [];
    const tags = tagData?.map((i) => ({ id: i.id, name: i.name })) || [];
    ...
    return (
      <View style={styles.container}>
        ...
        <TouchableOpacity
          ...
          onPress={() => console.log(selectedCategories, selectedTags)}
        >
